...
figure;
hold on;   
plot(SNR_value_range,SumRate_FP/users.num,'ro-','LineWidth',2);
plot(SNR_value_range,SumRate_DP/users.num,'bx-','LineWidth',2);
plot(SNR_value_range,SumRate_SP/users.num,'ks-','LineWidth',2);
