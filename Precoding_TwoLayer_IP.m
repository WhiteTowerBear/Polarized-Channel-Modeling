function [SecondPrecode]=Precoding_TwoLayer_IP(transmit,receive,users,ChanPol)
% function: 
% The two-layer precoding scheme with Imperfect CSI, i.e., the first layer removes 
